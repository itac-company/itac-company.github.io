...
checkboxes.addEventListener('input', () => {
    ...
    if (firstReview.checked) {
        reviewSlides[0].className = 'reviewItem reviewShow';
        reviewSlides[1].className = 'reviewItem reviewHide';
        reviewSlides[2].className = 'reviewItem reviewHide';
    }
})
...
body.addEventListener('wheel', () => {
    console.log(stages.clientHeight);
    console.log(window.pageYOffset)
    if (window.pageYOffset > 3600) {
        things.style.position = 'fixed';
        things.style.top = '300px';
        things.style.left = '800px';
    }
    if (window.pageYOffset > 6500 || window.pageYOffset < 3600) {
    ...
    if (window.pageYOffset > 4200) {
        firstThing.style.transform = 'scale(0)';
    }
